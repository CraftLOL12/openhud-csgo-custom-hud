...
import { createPlayer, deletePlayer, getPlayerBySteamId, getPlayers, updatePlayer, } from "../services/index.js";
export const getPlayersController = async (_req, res) => {
    try {
...
export const getPlayerBySteamIdController = async (req, res) => {
