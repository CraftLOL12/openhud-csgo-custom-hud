...
import { playerRoutes, teamRoutes, matchRoutes, coachRoutes, settingsRoutes, } from "./routes/index.js";
...
export const startServer = (mainWindow) => {
    ...
    ipcWebContentsSend("startServer", mainWindow.webContents, "Server started on port");
    return server;
};
